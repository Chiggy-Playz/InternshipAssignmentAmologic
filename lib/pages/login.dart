  ...
  Widget build(BuildContext context) {
    return Theme(
      data: context.theme.copyWith(
        ...
        headlineMedium: context.theme.textTheme.headlineMedium!.copyWith(
          fontFamily: "Poppins",
        ),
        bodyLarge: context.theme.textTheme.bodyLarge!.copyWith(
          fontFamily: "Poppins",
        ),
        titleMedium: context.theme.textTheme.titleMedium!.copyWith(
          fontFamily: "Poppins",
        ),
        displayMedium: context.theme.textTheme.displayMedium!.copyWith(
          fontFamily: "Poppins",
        ),
      )),
      child: Container(
                      ...
                      child: Align(
                        ...
                        child: TextFormField(
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(AmologicIcons.user),
                          ),
                      ...
                      child: Center(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            border: const OutlineInputBorder(
                                borderSide: BorderSide.none),
                            prefixIcon: const Icon(AmologicIcons.password),
                            suffixIcon: Padding(
